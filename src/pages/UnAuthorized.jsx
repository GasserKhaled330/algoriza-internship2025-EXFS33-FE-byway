    ...
    return (
        <main className="relative flex flex-col items-center justify-center min-h-screen p-6 overflow-hidden z-1">
            ...
            <div className="mx-auto w-full max-w-[242px] text-center sm:max-w-[472px]">
                <p className="text-base font-semibold text-[#465FFF]">403</p>

                <h1 className="mt-4 text-5xl font-semibold tracking-tight text-balance sm:text-7xl">Unauthorized</h1>
                ...
                <button
                    ...
                    onClick={handleGoBackBtn} data-discover="true">
